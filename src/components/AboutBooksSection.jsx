import styles from "../styles/AboutBooksSection.module.css";

export default function AboutBooksSection() {
  return (
    <section className={styles.aboutBooksSection} id="about-books">
      <div className={styles.container}>
        <h2 className={styles.heading}>Über meine Bücher</h2>
        <p className={styles.text}>
        In meiner Buchreihe widme ich mich einem der komplexesten und zugleich zutiefst menschlichen Themen: dem Bewusstsein in all seinen Facetten – besonders im Kontext von psychischer Erkrankung, spiritueller Erfahrung und persönlicher Entwicklung. Die sechs Werke bauen aufeinander auf und bilden ein zusammenhängendes Geflecht aus Selbsterfahrung, wissenschaftlicher Reflexion und praktischer Anleitung. Jedes Buch beleuchtet einen anderen Aspekt des Weges durch innere Krisen, Bewusstseinserweiterung und Genesung – mit besonderem Fokus auf die Erfahrung von Schizophrenie.
          </p>
          <br />
          <br />
...
<p>
Im zweiten Teil wird das Thema erweitert und vertieft. Der Fokus liegt hier auf Beispielen aus dem Tierreich und dem Bereich künstlicher Intelligenz, um Fragen nach Bewusstsein über das Menschsein hinaus zu stellen. Ich untersuche, wie sich Wahrnehmung und Selbstverständnis verändern, wenn man sich über die Grenzen des klassischen Denkens hinaus bewegt. Besonders spannend ist die Frage: Kann eine Maschine ein Bewusstsein entwickeln? Und was bedeutet das für unser Selbstbild?
          </p>
          <br />
          <br />
...
<p>
Diese sechs Bücher sind nicht nur Erfahrungsberichte, sondern Impulse für eine neue Sichtweise auf psychische Erkrankung, Heilung und Bewusstseinsentwicklung. Sie verbinden Wissenschaft, Spiritualität und Praxis in einer Weise, die Menschen berühren und stärken soll – ob Betroffene, Angehörige oder Fachpersonen. Ich verstehe die Reihe als ein Gesamtkunstwerk, das sowohl individuelle als auch gesellschaftliche Veränderung begleiten kann.

Wir leben in einer Zeit des Umbruchs – nicht nur technologisch, sondern auch seelisch. Psychische Krisen nehmen zu, während traditionelle Erklärungsmodelle oft an ihre Grenzen stoßen. Ich glaube fest daran, dass es neue Wege braucht, um Seele und Körper wieder in Einklang zu bringen. Und genau dazu möchte meine Buchreihe einen Beitrag leisten.
</p>

          <br />
          <br />
          <p>
          Insgesamt sind meine Bücher als Gesamtkunstwerk zu verstehen. Sie
          dokumentieren nicht nur einen individuellen Lebensweg, sondern liefern
          auch Impulse für die künftige Forschung und Therapie im Bereich
          psychosozialer Gesundheit. Ich glaube daran, dass wir in einer Zeit des
          Wandels leben – einer Zeit, in der alternative Perspektiven auf
          psychische Erkrankungen, Spiritualität und Heilung zunehmend
          an Bedeutung gewinnen.
          <br />
          <br />
          Es ist mein Wunsch, dass meine Bücher gelesen werden – nicht nur mit dem
          Kopf, sondern mit dem Herzen. Sie fordern heraus, bieten neue Denkweisen
          und laden zur Selbstreflexion ein. Vielleicht helfen sie, das Schweigen
          über psychische Erkrankungen zu brechen. Vielleicht wecken sie
          Mitgefühl. Vielleicht öffnen sie neue Wege.
        </p>
      </div>
    </section>
  );
